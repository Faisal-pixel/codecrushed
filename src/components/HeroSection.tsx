...
const HeroSection: React.FC = () => {
  ...
  const handlePlayClick = () => {
    ...
    if (!isPlaying) {
      window.open(
        "https://open.spotify.com/track/4kbj5MwxO1bq9wjT5g9HaA",
        "_blank"
      );
    }
  };
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-8 px-4 sm:px-0 text-center sm:text-left mx-auto sm:mx-0 w-full">
            <div className="space-y-2">
              ...
              <p
                className={`text-codecrushed-orange font-mono ${
                  showText ? "animate-fade-up" : "opacity-0"
                }`}
              ...
              >
                <span className="text-codecrushed-muted text-xl sm:text-2xl">
                  ...
                  <span className="animate-blink text-codecrushed-orange">
                    |
                  </span>
                </span>
              </div>
            ...
            <p
              className={`text-codecrushed-muted text-lg max-w-md mx-auto sm:mx-0 ${
                showText ? "animate-fade-up" : "opacity-0"
              }`}
              style={{ animationDelay: "800ms" }}
            >
              I craft engaging, scalable, and high-performance web solutions
              with React, Next.js, and modern web technologies. I am committed
              to delivering high-performance applications that are fast,
              accessible, and fully responsive across all devices. When I'm not
              coding, you'll probably find me listening to classical like Ray
            ...
            >
              <Button
                size="lg"
                className="bg-codecrushed-orange hover:bg-codecrushed-orange/90 text-black w-full sm:w-auto"
              >
                View My Work <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <a
                href="https://drive.google.com/uc?export=download&id=1JJiomhQp-LFlePY_IDbXw2ff2J2yWtqP"
                target="_blank"
              ...
              <div className="glass-card p-8 relative z-10">
                ...
                <div className="w-full aspect-square rounded-xl overflow-hidden bg-codecrushed-darker flex flex-col items-center justify-center relative">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://i.scdn.co/image/ab67616d0000b2734b2a42d1b5efbe0ec7dabcf1')",
                    }}
                  ></div>
                  ...
                  <div className="z-10 flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="text-xl font-bold text-codecrushed-light">
                      What'd I Say (Live)
                    </h3>
                      ...
                      <div
                        className={`${
                          typeof meImages[i] === "string"
                            ? "w-full h-full"
                            : "w-6 h-6"
                        }  rounded-full flex justify-center items-center bg-codecrushed-blue/30`}
                      >
                        {typeof meImages[i] === "string" ? (
                          <img
                            src={meImages[i]}
                          ...
                          <span className="text-codecrushed-blue text-lg font-bold">
                            {i + 1}
                          </span>
                        )}
                      </div>
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a
          href="#about"
          className="flex flex-col items-center text-codecrushed-muted hover:text-codecrushed-orange transition-colors duration-300"
        >
